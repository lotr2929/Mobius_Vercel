// api/_ai.js: Handles AI-related API interactions, including chat completions and model resolutions.
...
async function askOpenRouterCascade(messages) {
  ...
  const models = [
    { id: 'deepseek/deepseek-r1:free',               label: 'OpenRouter DeepSeek R1'       },
