...
REM ============================================================
REM Mobius deploy.bat — ported from the generic Vercel-deploy
REM template (see D:\_myProjects\_GPR\GPRTool\deploy.bat).
REM Requires deploy.env: VERCEL_TOKEN, VERCEL_PROJECT_ID, VERCEL_TEAM_ID,
REM                      PROJECT_NAME, DEPLOY_URL, SW_PREFIX
REM Requires _dev\poll_vercel.ps1
REM ============================================================

REM -- Pre-flight: Google Drive desktop sync conflict check
...
REM -- Validate imports, only if this project has an _assist.mjs (Mobius doesn't yet)
if exist "_assist.mjs" (
